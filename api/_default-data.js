...
// Each team has its own dataset — never mix men/women data!
const defaultTeams = {
  men: {
    posts: [
      {
    ...
    players: [
      {
        ...
        age: 20,
        status: "Активен",
        desc: "Капитан женской сборной. Отличное видение площадки и точные передачи.",
        image: ""
      },
      {
        id: 2,
        ...
        age: 21,
        status: "Активен",
        desc: "Мощная атакующая сила команды. Лучший бомбардир прошлого сезона.",
        image: ""
      },
      {
        id: 3,
        ...
        age: 19,
        status: "Активен",
        desc: "Надёжная защита и быстрая реакция. Основа обороны команды.",
        image: ""
      },
      {
        id: 4,
        ...
        age: 22,
        status: "Активен",
        desc: "Доминирует на сетке. Рекордсменка по количеству блоков.",
        image: ""
      },
      {
        id: 5,
        ...
        age: 20,
        status: "Активен",
        desc: "Универсальный игрок, одинаково сильна в атаке и на приёме.",
        image: ""
      },
      {
        id: 6,
        ...
        age: 21,
        status: "Активен",
        desc: "Техничный игрок с отличным игровым интеллектом и стабильной подачей.",
        image: ""
      }
    ],
    tournaments: [],
    homepage: {
      hero_title: "Женская сборная РГСУ",
      hero_subtitle: "Присоединяйтесь к женской волейбольной команде РГСУ. Сила, грация и командный дух.",
      button_text: "Подать заявку",
      button_link: "/about",
      hero_image: "",
      footer_address: "Москва, ул. Вильгельма Пика, д. 4, стр. 1",
...
// Backward-compatible export: default returns men's data
defaultTeams._data_version = 3;

export { defaultTeams };
export default defaultTeams.men;
